...
- Multitrack Studio with immutable serializable edits, a virtualized Canvas timeline, magnetic snapping, Web Audio preview, generated local sounds, EQ presets, and worker-rendered stereo WAV.
